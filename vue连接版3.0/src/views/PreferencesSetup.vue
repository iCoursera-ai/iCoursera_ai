  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          { value: 'U001', label: '编程开发', icon: 'fa fa-code mr-2' },
          { value: 'U002', label: '人工智能', icon: 'fa fa-paint-brush mr-2' },
          { value: 'U003', label: '商业管理', icon: 'fa fa-line-chart mr-2' },
          { value: 'U004', label: '数据科学', icon: 'fa fa-database mr-2' },
          { value: 'U005', label: '语言学习', icon: 'fa fa-language mr-2' },
          { value: 'U006', label: '市场营销', icon: 'fa fa-bullhorn mr-2' },
          { value: 'U007', label: '设计创意', icon: 'fa fa-user-plus mr-2'},
          { value: 'U008', label: '学术教育', icon: 'fa fa-book mr-2' }
        ],
        goals: [
          { value: 'U009', label: '职业技能', icon: 'fa fa-briefcase mr-2' },
          { value: 'U010', label: '职场提升', icon: 'fa fa-wrench mr-2' },
          { value: 'U011', label: '考研考证', icon: 'fa fa-certificate mr-2' },
          { value: 'U012', label: '生活兴趣', icon: 'fa fa-heart mr-2' },
          { value: 'U013', label: '教师成长', icon: 'fa fa-graduation-cap mr-2' },
          { value: 'U014', label: '创业指导', icon: 'fa fa-rocket mr-2' },
          { value: 'U015', label: '学生专区', icon: 'fa fa-rocket mr-2' },
        ],
        loading: false
      }
    },
