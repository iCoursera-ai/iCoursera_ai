  ...
  <div class="video-card">
    ...
    <div class="video-card-content">
      ...
      <div class="video-stats">
        ...
        <span class="stat">
          <i class="fas fa-comment"></i> {{ formatNumber(video.comments) }}
        </span>
  ...
  methods: {
    getThumbnailUrl(thumbnail) {
      ...
      const defaultImages = {
        ...
        'personal-development': 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=300&h=160&fit=crop'
      }
      
      return defaultImages[this.video.category] || 'https://images.unsplash.com/photo-1496171367470-9ed9a91ea931?w=300&h=160&fit=crop'
    },
    
    handleImageError(event) {
      // 图片加载失败时使用默认图片
      event.target.src = 'https://images.unsplash.com/photo-1496171367470-9ed9a91ea931?w=300&h=160&fit=crop'
    },
