...
export default {
  ...
  this.courses = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1627398242454-45a1465c2479?w=300&h=160&fit=crop',
      featured: true,
      isNew: false,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=300&h=160&fit=crop',
      featured: false,
      isNew: true,
      tags: ['营销', '策略'],
    ...
    },
    {
      id: 6,
      title: 'UI/UX 设计原理',
      instructor: '加州艺术学院 · Sarah Johnson',
      rating: 4.7,
      ratingCount: 3210,
      studentCount: 54321,
      price: 349,
      ...
      duration: '22小时',
      category: 'design',
      description: '掌握用户界面和用户体验设计的基本原则',
    ...
    },
    {
      id: 7,
      title: '商业分析入门',
      instructor: '宾夕法尼亚大学 · Robert Smith',
      rating: 4.5,
      ratingCount: 2987,
      studentCount: 65432,
      price: 299,
      ...
      duration: '16小时',
      category: 'business',
      description: '学习商业数据分析的基本方法和工具',
      image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=300&h=160&fit=crop',
      featured: false,
      isNew: true,
      tags: ['商业', '分析'],
    ...
    },
    {
      ...
      duration: '40小时',
      category: 'technology',
      description: '深入学习神经网络和深度学习的高级概念',
      image: 'https://images.unsplash.com/photo-1555255707-c07966088b7b?w=300&h=160&fit=crop',
      featured: true,
      isNew: false,
      tags: ['深度学习', '神经网络'],
